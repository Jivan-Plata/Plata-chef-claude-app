export default function IngredientsList(props) {
    ...
    return (
        <section className="flex flex-col gap-4">
            ...
            <div className="bg-[#f0efeb] rounded-[10px] w-full flex flex-row justify-between items-center py-[clamp(1rem,2vw+0.5rem,2rem)] px-[clamp(2rem,2vw+1.25rem,3rem)] my-8">
                ...
                <button className="border-none rounded-md bg-[#d17557] text-white py-[0.8rem] px-[1.8rem] font-inter text-sm cursor-pointer" onClick={props.getRecipe}>Get a recipe</button>
